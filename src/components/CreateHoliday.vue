<template>
  <section class="w-full md:flex flex-col md:items-center md:justify-center">
        <section class="border-2 bg-white md:hidden">
            <div class="flex justify-between">

                <div class="p-3">
                    <img src="/Illustrations/HolidayTracker.png" alt="logoApp" class="h-[70px] border-2 rounded-2xl">
        ...
        <section
            ...
            <div class="flex flex-col gap-y-5 md:gap-y-2">
                <div class="flex flex-col gap-y-5">
                    ...
                    <select class=" w-full md:w-full p-3 border border-gray-400 bg-gray-200 rounded-md shadow-sm">
                        <option>Choose your holiday's Type</option>
                ...
                <div class="flex flex-col gap-y-5">
                    ...
                    <textarea class="border border-gray-400 rounded-md p-2 w-full h-32 bg-gray-200"
                        placeholder="Please enter the description holiday..."></textarea>
                </div>

                <div class="flex justify-center m-5">
                    <button
                        class="rounded-md bg-blue-500 p-2 w-[300px] text-white font-bold shadow-lg shadow-blue-400">SUBMIT</button>
                </div>
            </div>
        </section>
    </section>
